...
* [Breadcrumbs navigation](../../ux-ui/common-components/breadcrumbs.md) - [Breadcrumb UI Kit](https://build.prestashop.com/prestashop-ui-kit/?path=/story/breadcrumb--breadcrumb).
...
* &#x20;[Pagination with input fields](../../ux-ui/common-components/pagination-with-input.md)
...
Sorting the table uses the [Sorting rules](../../ux-ui/common-components/sorting-rules.md) functionality. The sorting headers of the table are:
...
This page is [Multistores independent](../../ux-ui/common-components/multistores-independent.md) page.
