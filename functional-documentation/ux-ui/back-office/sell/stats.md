...
![Stats interface](<../../../../.gitbook/assets/image (1) (9).png>)
...
First part of the UI - [Filtering Components in Stats](../../common-components/stats-common-component/filtering-components-in-stats.md).
...
Once the Date format is filled incorrectly, in the [Filtering Components in Stats](../../common-components/stats-common-component/filtering-components-in-stats.md) UI component, the error message ([Alerts Basics UI Kit](https://build.prestashop.com/prestashop-ui-kit/?path=/story/alerts--basics)) is prompted in the front-end:
