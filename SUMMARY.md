  ...
  * [UX/UI](functional-documentation/ux-ui/README.md)
    ...
    * [Common components](functional-documentation/ux-ui/common-components.md)
      ...
      * [Forms](functional-documentation/ux-ui/common-components/forms/README.md)
        ...
        * [Language dropdown for input fields](functional-documentation/ux-ui/common-components/forms/language-dropdown-for-input-fields.md)
        * [Save button](functional-documentation/ux-ui/common-components/forms/save-button.md)
        * [Cancel button](functional-documentation/ux-ui/common-components/forms/cancel-button.md)
      * [Multistore component](functional-documentation/ux-ui/common-components/multistore-component/README.md)
        * [Configuration block](functional-documentation/ux-ui/common-components/multistore-component/configuration-block.md)
        * [Multistores dependent](functional-documentation/ux-ui/common-components/multistore-component/multistores-dependent.md)
        * [Multistores independent](functional-documentation/ux-ui/common-components/multistore-component/multistores-independent.md)
        * [Shop switcher](functional-documentation/ux-ui/common-components/multistore-component/shop-switcher.md)
        * [Shop switcher with eye icon](functional-documentation/ux-ui/common-components/multistore-component/shop-switcher-with-eye-icon.md)
      ...
      * [Grid component](functional-documentation/ux-ui/common-components/grid-component/README.md)
        * [Checkmark navigation CTA buttons](functional-documentation/ux-ui/common-components/grid-component/checkmark-navigation-cta-buttons.md)
        * [Sorting rules](functional-documentation/ux-ui/common-components/grid-component/sorting-rules.md)
        * [Settings wheel](functional-documentation/ux-ui/common-components/grid-component/settings-wheel.md)
        * [Pagination](functional-documentation/ux-ui/common-components/grid-component/pagination.md)
        * [Pagination with input](functional-documentation/ux-ui/common-components/grid-component/pagination-with-input.md)
      ...
      * [Back office Header](functional-documentation/ux-ui/common-components/back-office-header/README.md)
        * [PrestaShop version number](functional-documentation/ux-ui/common-components/back-office-header/prestashop-version-number.md)
        * [Account icon](functional-documentation/ux-ui/common-components/back-office-header/account-icon.md)
        * [Breadcrumbs](functional-documentation/ux-ui/common-components/back-office-header/breadcrumbs.md)
        * [Heading of the page](functional-documentation/ux-ui/common-components/back-office-header/heading-of-the-page.md)
        * [Bell icon](functional-documentation/ux-ui/common-components/back-office-header/bell-icon.md)
        * [PrestaShop logo](functional-documentation/ux-ui/common-components/back-office-header/prestashop-logo.md)
        * [Help Button](functional-documentation/ux-ui/common-components/back-office-header/help-button.md)
        * [Save and stay button](functional-documentation/ux-ui/common-components/back-office-header/save-and-stay-button.md)
        * [View my shop](functional-documentation/ux-ui/common-components/back-office-header/view-my-shop.md)
        * [Search input field](functional-documentation/ux-ui/common-components/back-office-header/search-input-field.md)
